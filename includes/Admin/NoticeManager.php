...
final class NoticeManager {
	...
	/**
	 * LW Slider's own screens are the post type screens (edit.php, post.php,
	 * post-new.php) that sit under the LW Plugins menu. They carry no `page`
	 * query arg, so the menu-slug check above does not see them.
	 */
	private static function is_slider_screen(): bool {
		$screen = function_exists( 'get_current_screen' ) ? get_current_screen() : null;

		return $screen instanceof \WP_Screen && SliderPostType::POST_TYPE === $screen->post_type;
	}
